...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        double cFromFPxtradumb = lawOfCosinesAngleC.apply(3.0).apply(3.0).apply(5.0);
        System.out.println(cFromOO);
        System.out.println(cFromFPDumb);
        System.out.println(cFromFPSmart);
        System.out.println(cFromFPxtradumb);
    }
    ...
    public static Function<Double, Function<Double, Function<Double, Double>>> lawOfCosinesAngleC = (
            a) -> (b) -> (c) -> {
                ...
                double bSq = b * b;
                double cSq = c * c;
                double hi = cSq-aSq-bSq;
                double hey = -2 * a * b;
                double angleC = Math.acos(hi / hey);
                return angleC;
